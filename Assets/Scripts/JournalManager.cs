...
public class JournalManager : MonoBehaviour
{
    ...
    [Header("Audio Mixing")]
    [Tooltip("Writing sounds, page flips, and pick-up are all SFX — route them here so they follow the SFX slider.")]
    ...
    void Start()
    {
        ...
        if (sfxMixerGroup != null) _journalAudio.outputAudioMixerGroup = sfxMixerGroup;
        ...
        if (sfxMixerGroup != null) _leftPageAudio.outputAudioMixerGroup = sfxMixerGroup;
        ...
        if (sfxMixerGroup != null) _rightPageAudio.outputAudioMixerGroup = sfxMixerGroup;
    }
